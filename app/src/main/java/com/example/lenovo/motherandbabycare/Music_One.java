...
public class Music_One extends AppCompatActivity {
    Button playButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music__one);
        getSupportActionBar().setTitle("Emotion Music");
        ...
        mp=MediaPlayer.create(this,R.raw.emotion_music);
        mp.setLooping(true);
        mp.seekTo(0);
