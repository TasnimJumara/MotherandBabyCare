...
public class Music_Two extends AppCompatActivity {
    Button playButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music__two);
        getSupportActionBar().setTitle("Enchanted Piano Music");
        ...
        mp=MediaPlayer.create(this,R.raw.enchanted_piano_music);
        mp.setLooping(true);
        mp.seekTo(0);
