...
public class Lullaby_Four extends AppCompatActivity {
    Button playButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lullaby__four);
        getSupportActionBar().setTitle("Little Star Lullaby");
        ...
        mp=MediaPlayer.create(this,R.raw.twinkle_twinkle_little_star_lullaby);
        mp.setLooping(true);
        mp.seekTo(0);
