...
public class Music_Three extends AppCompatActivity {
    Button playButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music__three);
        getSupportActionBar().setTitle("Peaceful Mind Music");
        ...
        mp=MediaPlayer.create(this,R.raw.peaceful_mind_music);
        mp.setLooping(true);
        mp.seekTo(0);
