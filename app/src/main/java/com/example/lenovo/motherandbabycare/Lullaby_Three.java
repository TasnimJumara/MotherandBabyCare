...
public class Lullaby_Three extends AppCompatActivity {
    Button playButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lullaby__three);
        getSupportActionBar().setTitle("Little Horse Lullaby");
        ...
        mp=MediaPlayer.create(this,R.raw.pretty_little_horses_lullaby);
        mp.setLooping(true);
        mp.seekTo(0);
