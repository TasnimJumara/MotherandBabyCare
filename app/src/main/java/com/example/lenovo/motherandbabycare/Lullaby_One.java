...
public class Lullaby_One extends AppCompatActivity {
    Button playButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lullaby__one);
        getSupportActionBar().setTitle("Goodnight Lullaby");
        ...
        mp=MediaPlayer.create(this,R.raw.goodnight_lullaby);
        mp.setLooping(true);
        mp.seekTo(0);
