...
public class Music_Five extends AppCompatActivity {
    Button playButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music__five);
        getSupportActionBar().setTitle("Soothing Music");
        ...
        mp=MediaPlayer.create(this,R.raw.spiritually_soothing_music);
        mp.setLooping(true);
        mp.seekTo(0);
