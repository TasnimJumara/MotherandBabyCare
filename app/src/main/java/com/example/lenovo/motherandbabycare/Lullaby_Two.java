...
public class Lullaby_Two extends AppCompatActivity {
    Button playButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lullaby__two);
        getSupportActionBar().setTitle("Little Baby Lullaby");
        ...
        mp=MediaPlayer.create(this,R.raw.hush_little_baby_lullaby);
        mp.setLooping(true);
        mp.seekTo(0);
