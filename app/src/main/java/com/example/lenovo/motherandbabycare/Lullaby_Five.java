...
public class Lullaby_Five extends AppCompatActivity {
    Button playButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lullaby__five);
        getSupportActionBar().setTitle("Rock baby Lullaby");
        ...
        mp=MediaPlayer.create(this,R.raw.rock_baby_lullaby);
        mp.setLooping(true);
        mp.seekTo(0);
